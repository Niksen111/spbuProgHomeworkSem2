...
public class Tests
{
    ...
    {
        IConfigurationGenerator generator = new ConfigurationGenerator("../../../InputFile1.txt");
    ...
    {
        IConfigurationGenerator generator = new ConfigurationGenerator("../../../InputFile2.txt");
    ...
    {
        IConfigurationGenerator generator = new ConfigurationGenerator("../../../InputFile3.txt");
